...
public class PulseVersionFetcher implements VersionFetcher {
    ...
    public Component getVersionMessage() {
        ...
        if (BUILD_INFO.buildNumber().isEmpty()) {
            updateMessage = text("You are running a custom version without access to version information", color(0xF54263));
        } else {
